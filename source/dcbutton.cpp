...
void DCButton::OnPaint(wxPaintEvent& event)
{
	...
	if(highlight_pen.get() == nullptr)      highlight_pen.reset(newd wxPen(wxColor(0xFF,0xFF,0xFF), 1, wxPENSTYLE_SOLID));
	if(dark_highlight_pen.get() == nullptr) dark_highlight_pen.reset(newd wxPen(wxColor(0xD4,0xD0,0xC8), 1, wxPENSTYLE_SOLID));
